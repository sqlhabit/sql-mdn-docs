...
| --- | --- | --- |
| [Bindle dataset](https://sqlhabit.github.io/sql_schema_visualizer/databases/bindle) | 1 | This data warehouse belongs to a fictional startup named Bindle. Bindle is a web and mobile app for reading books, it has subscription business model. The SQL Habit Course is based on Bindle’s story. 📖 Bindle’s data warehouse contains everything needed to run a modern Internet company – web and mobile analytics, marketing data, AB-test data, etc. |
| [E-commerce dataset](https://sqlhabit.github.io/sql_schema_visualizer/databases/ecommerce) | 2 | This data warehouse is inspired by an E-commerce website like Amazon. 🛒 Our E-commerce website allows vendors to sell items in multiple categories. Users can add as many items as they want to a cart and then purchase a cart with/without a discount code. Users also can return items and leave reviews. |
| [Finance dataset](https://sqlhabit.github.io/sql_schema_visualizer/databases/finance) | 3 | This data warehouse simply contains all company’s financial transactions. 💵 If the company paid for something – there’s a debit transaction with negative amount. If someone paid the company – it’s a credit transaction with positive amount. 💰 |
| [Live dataset](https://sqlhabit.github.io/sql_schema_visualizer/databases/live) | 4 | The Live dataset contains data of a meditation mobile app with subscription business model. 📱 The data is updated daily. You can run queries to calculate metrics for the past 24h, week, month, etc. and build dashboards as if you were actually working for that company. 📊 |
| [NBA dataset](https://sqlhabit.github.io/sql_schema_visualizer/databases/nba) | 5 | The NBA dataset contains stats of NBA games since 1949. It is regularly updated. The dataset contains aggregated game stats (team_game_stats table) and individual player stats per quarter or overtime period (player_period_stats). Have a ball! 🏀 |
